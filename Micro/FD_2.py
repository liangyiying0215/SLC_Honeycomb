...
mat = cv2.imread("/Users/liangyiying/Desktop/fx/edge2/f3-03.jpg")
...
img_z.save("/Users/liangyiying/Desktop/fx/black_white_edge2/fx_03.jpg")

        
logN = []
logfR = []
for logR in numpy.arange(1.5, 3, 0.07):
    print('************')
    R = (10) ** logR
    N = 0
